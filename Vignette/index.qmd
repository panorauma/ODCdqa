...
There will be 2 versions of ODCdqa:
...
To install ODCdqa, run the following lines of code in R console:

```{r}
#| echo: true
install.packages("devtools")

devtools::install_github("panorauma/ODCdqa")
```
...
The functions listed below are specific to the package version of the ODCdqa.
